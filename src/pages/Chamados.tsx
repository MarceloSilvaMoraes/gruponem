  ...
  return (
    <div className="p-4 md:p-6 space-y-5">
            ...
            {!selectMode ? (
              ...
              <>
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      <AlertDialogTitle>Excluir {selected.size} chamado(s)?</AlertDialogTitle>
                      <AlertDialogDescription>
                        Esta ação não pode ser desfeita. Mensagens, notas e histórico desses chamados também serão removidos.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
      ...
      <div className="space-y-3">
        {isLoading && <p className="text-center text-muted-foreground py-12">Carregando...</p>}
        ...
        {filtered?.map((ticket) => (
          <TicketCard
            ...
            ticket={ticket}
            onClick={() =>
              selectMode ? toggleSelect(ticket.id) : navigate(`/ticket/${ticket.id}`)
            }
